...
def main():
    ...
    model_params_file = r"/scratch/eecs568s001w25_class_root/eecs568s001w25_class/yiweigui/bev-global-mapping/motionnet/Configs/MotionNet.yaml"
    ...
    # Change this path to your own path
    data_params_file = r"/scratch/eecs568s001w25_class_root/eecs568s001w25_class/yiweigui/bev-global-mapping/motionnet/Configs/kitti.yaml"
        ...
        for input_data, output in tqdm(dataloader_train):
            ...
            if DEBUG and count%200 == 0:
                ...
                for i in range(T):
                    ...
                    input_temp = input_data[-1,i,:].detach().cpu().numpy().astype(np.uint8) # Get 200 x 200 instead  256 x 256 grid
